...
// drawing pen to the specified position. 
// supplies a list of points to be
// drawn.
...
function initCanvas () {
  ...
  div_canvas = document.getElementById("div_canvas");//divisoes em que o canvas esta inserido
  div_canvas2 = document.getElementById("div_canvas2");
...
var img = new Image();
    img.onload = function(){
    canvas.width = 0.60*screen_width;
    canvas.height = 0.5*img.height;
    context.drawImage(img, 0, 0, 0.60*screen_width, 0.5*img.height);
}

img.src = 'static/img/nbpaper.png';

video = document.getElementById("video");
video.width = 0.30*screen_width;
video.height = 0.45*screen_height;

//tool = document.getElementById("tool");
//tool.width = 0.25*screen_width;
//tool.height = 0.45*screen_height;
...
function roomOccupantCountUpdateListener (roomID, numOccupants) {
  ...
  if (numOccupants == 1) {
    setStatus("Nº de pessoas a usar o notebook interactivo: 1");
  } else if (numOccupants == 2) {
    setStatus("Nº de pessoas a usar o notebook interactivo: " + (numOccupants));
  } else {
    setStatus("Nº de pessoas a usar o notebook interactivo: " + (numOccupants));
  }
}
...
function pointerDownListener (e) {
  ...
  var mouseX = event.clientX - canvas.offsetLeft - div_canvas.offsetLeft;
  var mouseY = event.clientY - canvas.offsetTop + yOffset - div_canvas.offsetTop;
